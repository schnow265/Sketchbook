package at.schnow265.sketchbook.block;
...
public class ModBlocks {
    ...
    private static Block registerBlock(String name, Block block) {
        ...
        return Registry.register(Registries.BLOCK, new Identifier(drawbook.MOD_ID, name), block);
    }

    private static Item registerBlockItem(String name, Block block) {
        return Registry.register(Registries.ITEM, new Identifier(drawbook.MOD_ID, name),
                new BlockItem(block, new FabricItemSettings()));
    }

    public static void registerModBlocks() {
        drawbook.LOGGER.info("Registering ModBlocks for " + drawbook.MOD_ID);
    }
}